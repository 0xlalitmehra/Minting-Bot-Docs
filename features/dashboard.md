...
The Dashboard is your home base — quick utilities you reach for during drop prep without breaking flow. It's a grid of small tools, each useful on its own.

![Dashboard view with the Floor-Based Gas Calculator open and a recommended priority fee on the right.](../.gitbook/assets/dashboard.jpg)
...
Paste that hex into a Custom task's payload field.
...
Output: net profit/loss after fees.
